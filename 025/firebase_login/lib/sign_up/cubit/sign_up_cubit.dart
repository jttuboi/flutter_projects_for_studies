...
class SignUpCubit extends Cubit<SignUpState> {
  ...
  void emailChanged(String value) {
    ...
    emit(state.copyWith(email: email, status: Formz.validate([email, state.password, state.confirmedPassword])));
  }
  ...
  void confirmedPasswordChanged(String value) {
    ...
    emit(state.copyWith(confirmedPassword: confirmedPassword, status: Formz.validate([state.email, state.password, confirmedPassword])));
  }
