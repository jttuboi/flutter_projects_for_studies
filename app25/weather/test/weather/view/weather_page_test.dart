...
void main() {
  ...
  group('WeatherView', () {
    ...
    testWidgets('renders WeatherEmpty for WeatherStatus.initial', (tester) async {
    ...
    testWidgets('renders WeatherLoading for WeatherStatus.loading', (tester) async {
      when(() => weatherCubit.state).thenReturn(WeatherState(
    ...
    testWidgets('renders WeatherPopulated for WeatherStatus.success', (tester) async {
      when(() => weatherCubit.state).thenReturn(WeatherState(
    ...
    testWidgets('renders WeatherError for WeatherStatus.failure', (tester) async {
      when(() => weatherCubit.state).thenReturn(WeatherState(
    ...
    testWidgets('state is cached', (tester) async {
      ...
      await tester.pumpWidget(BlocProvider.value(
        value: WeatherCubit(weatherRepository: MockWeatherRepository()),
        child: MaterialApp(home: WeatherView()),
      ));
      expect(find.byType(WeatherPopulated), findsOneWidget);
    });
    ...
    testWidgets('navigates to SearchPage when search button is tapped', (tester) async {
      when(() => weatherCubit.state).thenReturn(WeatherState());
      await tester.pumpWidget(BlocProvider.value(
        value: weatherCubit,
        child: MaterialApp(home: WeatherView()),
