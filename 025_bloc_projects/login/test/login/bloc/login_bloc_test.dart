  ...
  group('LoginBloc', () {
    ...
    group('LoginSubmitted', () {
      blocTest<LoginBloc, LoginState>(
        ...
        setUp: () {
          when(() => authenticationRepository.logIn(username: 'username', password: 'password')).thenAnswer((_) => Future.value('user'));
        },
        build: () => LoginBloc(
          authenticationRepository: authenticationRepository,
        ),
      ...
      blocTest<LoginBloc, LoginState>(
        ...
        setUp: () {
          when(() => authenticationRepository.logIn(username: 'username', password: 'password')).thenThrow(Exception('oops'));
        },
        build: () => LoginBloc(
          authenticationRepository: authenticationRepository,
        ),
