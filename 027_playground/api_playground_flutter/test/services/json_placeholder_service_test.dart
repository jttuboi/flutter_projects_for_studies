...
void main() async {
  final httpClient = IHttpClientMock();
  final service = JsonPlaceholderService(httpClient);

  test('must return all todos', () async {
    when(() => httpClient.get(any())).thenAnswer((invocation) async => jsonDecode(data));
