...
class AppNestedRoutes extends StatefulWidget {
  const AppNestedRoutes({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _AppNestedRoutesState();
}

class _AppNestedRoutesState extends State<AppNestedRoutes> {
